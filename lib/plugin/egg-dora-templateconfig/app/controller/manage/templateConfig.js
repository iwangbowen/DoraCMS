...
let TemplateConfigController = {
    ...
    async getTempItemForderList(ctx, app) {
        ...
        try {
            ...
            let filePath = ctx.helper.scanJustFolder(app.config.temp_view_folder + defaultTemp.alias);
        ...
        try {
            if (tempId) {
                ...
                if (!_.isEmpty(templateInfo)) {
                    ...
                    let DOWNLOAD_DIR = app.config.temp_view_folder + file_targetForlder.trim() + '/';
    ...
    async uploadCMSTemplate(ctx, app) {
        ...
        var target_path = app.config.temp_view_folder + forderName + '.zip';
        var DOWNLOAD_DIR = app.config.temp_view_folder + forderName + '/';
                ...
                return new Promise((resolve, reject) => {
                    ...
                    extract.on('finish', async function () {
                        ...
                        if (checkResult == '1') {
                            ...
                            var tempForder = app.config.temp_view_folder + targetForder;
                                        ...
                                        if (tempInfoData && tempInfoData.name && tempInfoData.alias && tempInfoData.version && tempInfoData.author && tempInfoData.comment) {
                                            ...
                                            try {
                                                ...
                                                if (validateTempInfo != 'success') {
                                                    ...
                                                    var fromPath = app.config.temp_view_folder + targetForder + '/dist/';
                                                    let assetsPath = app.config.temp_view_folder + targetForder + '/assets/';
                                                    var targetPath = temp_static_folder + targetForder;
